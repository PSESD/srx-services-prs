...
class StudentTests extends FunSuite with BeforeAndAfterAll {
  ...
  val authorizedEntity = AuthorizedEntity(0, "authorized entity", Some(contact))
  ...
  test("create") {
    ...
    val result = Student.create(student, List[SifRequestParameter](new SifRequestParameter("zoneId", "seattle"), new SifRequestParameter("generatorId", "test"))).asInstanceOf[StudentResult]
  ...
  test("update duplicate") {
    ...
    val createdStudentResult = Student.create(student, List[SifRequestParameter](new SifRequestParameter("zoneId", "seattle"), new SifRequestParameter("generatorId", "test"))).asInstanceOf[StudentResult]
