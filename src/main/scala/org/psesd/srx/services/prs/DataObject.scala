...
object DataObject extends PrsEntityService {
  ...
  def apply(requestBody: SrxRequestBody, parameters: Option[List[SifRequestParameter]]): DataObject = {
    if (requestBody == null) {
