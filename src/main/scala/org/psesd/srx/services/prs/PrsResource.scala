...
object PrsResource extends ExtendedEnumeration {
  ...
  val DistrictServices = Value("districtServices")
  val DistrictServicePersonnel = Value("districtServicePersonnel")
  val DistrictServiceStudents = Value("districtServiceStudents")
  val DistrictStudents = Value("districtStudents")
